...
/*
 * GPIO konfigürasyonlarý hem 0. pin (potansiyometre - PA0) için
 * hem de 4. pin (DAC - PA4 pini) için yapýldý.
 * */
void GPIO_Config()
{
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  DAC_SetChannel1Data(DAC_Align_12b_R, adc_value); // ADC'den alýnan deðer DAC'ye atýlýr.
